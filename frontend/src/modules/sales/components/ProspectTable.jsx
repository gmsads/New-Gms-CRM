    ...
    <div className="space-y-4">
      ...
      <div className="rounded-xl border bg-white shadow-sm p-4">
        ...
        <div className="flex flex-col sm:flex-row flex-wrap gap-3">
          <button onClick={handleExportToExcel} className="flex justify-center items-center gap-2 h-10 px-6 rounded text-white font-semibold text-sm transition-colors hover:opacity-90 shadow-sm w-full sm:w-auto" style={{ background: '#4caf50' }}>
          ...
          <input 
            ...
            className="hidden" 
          />
          <button onClick={() => fileInputRef.current?.click()} className="flex justify-center items-center gap-2 h-10 px-6 rounded text-white font-semibold text-sm transition-colors hover:opacity-90 shadow-sm w-full sm:w-auto" style={{ background: '#1976d2' }}>
            <FileText className="h-4 w-4" /> Import from Excel
          </button>
          <button onClick={handlePrint} className="flex justify-center items-center gap-2 h-10 px-6 rounded text-white font-semibold text-sm transition-colors hover:opacity-90 shadow-sm w-full sm:w-auto" style={{ background: '#00acc1' }}>
