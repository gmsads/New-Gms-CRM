...
const AdminDashboard = () => {
  ...
  return (
    <div className="space-y-4 sm:space-y-6 lg:space-y-8 pb-10 min-w-0">
      ...
      <div className="flex flex-col lg:flex-row items-stretch lg:items-end gap-4 bg-white p-4 sm:p-6 rounded-2xl border shadow-sm min-w-0">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 flex-1 w-full min-w-0">
