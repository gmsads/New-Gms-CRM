...
const AdminDashboard = () => {
  ...
  return (
    <div className="space-y-8 pb-10">
      ...
      <div className="flex flex-col md:flex-row items-end gap-4 bg-white p-4 sm:p-6 rounded-2xl border shadow-sm">
        ...
        <button onClick={() => refetch()} className="w-full md:w-auto h-10 px-6 rounded-xl bg-slate-900 text-white text-sm font-bold hover:bg-slate-800 transition-all active:scale-95">Generate Report</button>
      </div>
